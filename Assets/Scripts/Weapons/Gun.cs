...
namespace Weapons
{
    public class Gun : MonoBehaviour
    {
        ...
        {
            Assert.IsNotNull(_grabInteractable, message:"You have not assigned a grab interactable to gun");
            Assert.IsNotNull(_gunBarrel,"You have not assigned a gun barrel to gun");
            Assert.IsNotNull(_ammoSocket,"You have not assigned a ammo socket to gun");
        ...
        //Ignore collision between the interactable and an object
